package com.example.callsave_091;
...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btnCall = findViewById(R.id.btnCall);btnSave = findViewById(R.id.btnSave);
        btnRemove = findViewById(R.id.btnRemove);btnStar = findViewById(R.id.btnStar);
